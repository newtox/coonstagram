...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./run/media/justin/B4BADFC8BADF8570/Development/coonstagram/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./run/media/justin/B4BADFC8BADF8570/Development/coonstagram/public/storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','admin',);
        registerArgumentsSet('routes', 'dashboard','locale.switch','profile.show',
'profile.edit','profile.update','profile.destroy','profile.avatar.destroy','posts.like',
'comments.store','users.follow','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','posts.store','posts.destroy','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.avatar','components.coonstagram-layout','components.input-error','feed.index',
'layouts.guest','partials.post-card','profile.edit','profile.show','welcome',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','coonstagram.feed','coonstagram.for_you',
'coonstagram.following_tab','coonstagram.whats_new','coonstagram.post','coonstagram.post_as_yourself','coonstagram.delete_confirm',
'coonstagram.delete','coonstagram.follow','coonstagram.following','coonstagram.likes','coonstagram.comments',
'coonstagram.write_comment','coonstagram.reply','coonstagram.reply_placeholder','coonstagram.send','coonstagram.no_posts',
'coonstagram.no_posts_following','coonstagram.posts_label','coonstagram.followers_label','coonstagram.following_label','coonstagram.latest_followers',
'coonstagram.no_followers','coonstagram.back_to_feed','coonstagram.logout','coonstagram.my_profile','coonstagram.edit_profile',
'coonstagram.profile_info','coonstagram.profile_updated','coonstagram.avatar_removed','coonstagram.avatar','coonstagram.reset',
'coonstagram.delete_avatar_confirm','coonstagram.name','coonstagram.username','coonstagram.display_name','coonstagram.title_tagline',
'coonstagram.bio','coonstagram.email','coonstagram.email_unverified','coonstagram.resend_verification','coonstagram.save',
'coonstagram.change_password','coonstagram.current_password','coonstagram.new_password','coonstagram.confirm_new_password','coonstagram.save_password',
'coonstagram.password','coonstagram.delete_account','coonstagram.delete_account_warning','coonstagram.delete_account_confirm','coonstagram.language',
'coonstagram.select_language','coonstagram.german','coonstagram.english','coonstagram.login','coonstagram.login_welcome',
'coonstagram.remember_me','coonstagram.forgot_password','coonstagram.no_account','coonstagram.register','coonstagram.register_welcome',
'coonstagram.already_registered','coonstagram.password_confirmation','coonstagram.forgot_password_title','coonstagram.forgot_password_text','coonstagram.send_reset_link',
'coonstagram.reset_password_title','coonstagram.reset_password_button','coonstagram.confirm_password_title','coonstagram.confirm_password_text','coonstagram.confirm',
'coonstagram.verify_email_title','coonstagram.verify_email_text','coonstagram.verify_email_resent','coonstagram.resend_email',);
